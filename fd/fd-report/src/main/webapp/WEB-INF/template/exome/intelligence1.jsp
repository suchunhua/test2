...
<div class="jumbotron">
    <h1 class="big-title big-font">${interestTestDetail.intelligence.intelName}</h1>
    <%-- <span class="subtitle">${interestTestDetail.intelligence.intelName}简介：</span> --%>
    <div class="acticle">
        ${interestTestDetail.intelligence.introduce}
    </div>
</div>
<div class="wrap re-wrap">
    <h1 class="big-title big-font">${interestTestDetail.intelligence.intelName}详情</h1>
    ...
    <table class="title-garden-table table1" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr><td colspan="4">结论：${interestTestDetail.intelligen.ability}</td></tr>
        </tbody>
    </table>
