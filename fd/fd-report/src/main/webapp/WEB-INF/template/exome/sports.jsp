...
<div class="wrap re-wrap">
    <h1 class="big-title big-font">运动天赋汇总</h1>
    <table class="title-garden-table table1" cellspacing="0" cellpadding="0">
        <thead>
            <tr><th>类别</th><th>运动能力分析（ 低<img src="${ctx }/static/img/admin/reportPrint/pic/low_.png"/> 正常<img src="${ctx }/static/img/admin/reportPrint/pic/normal_.png"/> 高<img src="${ctx }/static/img/admin/reportPrint/pic/high_.png"/>）</th></tr>
        </thead>
        <tbody>
            <c:forEach items="${interestTestList.sportList }" var="temp">
                <tr><td><span style="display:none;">${temp.category}</span>
                <form method="post" action="${ctx }/exome/ydtfDet" style="display: inline-block;vertical-align: top;">
