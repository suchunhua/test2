    ...
    <div class="section img">
        ...
        <table class="hidden-sm hidden-xs">
            ...
            <tbody>
                <tr>
                    <td>外周血</td>
                    <td>5ml全血，专用的Cell free DNA tube（cfDNA保存管）收集,采血后请立即轻柔颠倒1 0次使血液与管内成分混匀</td>
                    <td>防压、防漏，常温运输</td>
                    <td>建议自样本取出72h 内送检</td>
                </tr>
                <tr>
                    <td>口腔拭子</td>
                    <td>用2个拭子各旋转刮拭脸颊内侧20次，请尽量避免接触牙齿和舌头</td>
                    <td>常温运输</td>
                    <td>严格按说明书操作</td>
                </tr>
            </tbody>
