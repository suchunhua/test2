$(function(){
  var height = document.documentElement.clientHeight - $('.footer')[0].clientHeight - 200; 
  $('.chart').height(height);
  ...
  if(300<=document.body.clientWidth && document.body.clientWidth <=640 ) { //判断浏览器可视宽度是不是在300到640之间
	  ...
	  var full = $('#fullpage').fullpage({
		    ...
		    // navigationColor:'black',
		      ...
		      // if()
		      console.log(index,159);
		      $('.footer-bg').removeClass('footer-bg-fixed');
		  		if(index == 5){
		        $('header.transparent').removeClass('transparent');
		        $('.footer-bg').addClass('footer-bg-fixed');
