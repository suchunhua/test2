...
public class OOriginMoveTestService extends BaseTest {
	...
	public void test() {
		...
		String[] pinArray = {"B","Adam","CT","A","E","F","K","J1","J2","R1b","I2","R1a","R1","N","I1","Q1a","Q1b","G","H","R","L","P","R2","O2","O","D","C2","O1","C5","C4","C1","C3"};
		// 定义标记对应的图片数组
		String[][] mapArray = { { "X", "A", "B", "D", "C" }, // 7 map1
				{ "O", "S", "P","M",   "M14", "M15", "Q", "M29", "M28", "M27", "M24", "M42","N",  "N12", "N13", "N14" }, // 4
																												// map2
				{ "N",  "N1", "X", "A", "B", "U", "L0a", "L0f", "L0k", "L0d", "L1b", "L1c", "L5", "L2", "L6", "L4",
						"L3b", "L3f", "L3c", "L3d", "L3e", "L3i", "L3x", "L3h" }, // 6
																					// map3
				{ "B", "E", "M",   "M1", "M19", "M23", "M32","N",   "N9a", "N10", "N11", "O", "N12", "N21", "N22" }, // 5
																										// map4
				{ "N",  "N2", "U", "R5", "R6", "R7", "R8","M",    "M2", "M3", "M4'67", "M5", "M6", "M31", "M32'56", "M34'57", "M10",
						"M18", "M33", "M34", "M35", "M37", "M38", "M39", "M4", "M40", "M41", "N1d", "I", "N5", "W" }, // 2
																														// map5
				{ "Z","N",   "N1", "N2", "X", "H", "V", "J", "T", "U","M",    "M30", "N1b", "N1c", "N1a", "I", "N2a", "W" }, // 3
																												// map8and9
				{ "B", "N",  "N9", "A", "F", "R9b", "D", "G", "M",   "M9a", "Z", "C", "M7", "M51", "M10", "M11", "M12", "M13", "M17",
						"M20", "M21", "M28", "M75", "M8", "M9", "N1a", "N8", "N9a", "N9b", "Y", "N10", "N11", "N22" }// 1
																														// map10
		};
		if (oOriginMoveList != null && !oOriginMoveList.isEmpty()) {
			...
			for (OOriginMove oOriginMove : oOriginMoveList) {
				...
				if ("Y".equals(oOriginMove.getOriginType())) {
					...
					needSignPin = (needSignPin != null && !"".equals(needSignPin)) ? needSignPin.substring(1, needSignPin.length())
							: "";
