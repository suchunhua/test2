...
var popup = {
		...
		pageBottom:{
			...
			init:function(param){
				var oPopupBox = '<div class="popup-box"> <div class="popup-shade" onclick="popup.pageBottom.hide();"></div> <div class="popup-content-box pageBottom"> <div class="popup-content"></div> <div class="popup-close"><i class="icon-fd-white-close" onclick="popup.pageBottom.hide();"></i></div> </div></div>';
				$(".view").append(oPopupBox);
				$(".popup-content").append($(param));
				var trueText='<div class="true" onclick="popup.pageBottom.hide();">确&nbsp;定</div>';
